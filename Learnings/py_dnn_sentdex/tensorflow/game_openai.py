...
def some_some_random_games_first() :
...
def train_model(training_data, model=False):
    ...
    model.fit({'input':X},{'targets' : Y}, n_epochs=3, snapshot_step=500, show_metric=True, run_id='openaicartpole')
